              ...
              <div className="max-w-3xl mx-auto p-4">
                ...
                <div className="space-y-2 max-h-[300px] overflow-y-auto mb-4">
                  {parsedTasks.map((task, index) => (
                    ...
                    >
                      <div className="w-6 h-6 rounded-full bg-slate-300 dark:bg-slate-700 flex items-center justify-center text-xs font-bold text-slate-600 dark:text-slate-300 flex-shrink-0 mt-0.5">
                        {index + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="font-medium text-slate-800 dark:text-slate-200">{task.text}</p>
                ...
                <div className="flex items-center justify-end gap-3">
                  <button
                    onClick={handleCancelTasks}
                    className="px-4 py-2.5 text-slate-600 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-xl font-medium transition-colors flex items-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-emerald-600 dark:bg-emerald-500 text-white rounded-xl font-medium hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-colors flex items-center gap-2 shadow-lg shadow-emerald-600/20"
                  >
          ...
          <div className="bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 shadow-lg">
            <div className="max-w-3xl mx-auto p-4">
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mt-2 text-center">
                {hasApiKey ? (
                  <>Press <kbd className="px-1.5 py-0.5 bg-slate-200 dark:bg-slate-800 rounded text-slate-500 dark:text-slate-400">Enter</kbd> to parse tasks with AI</>
                ) : (
